...
class AdminPanel:
    ...
    def warning_info(self):
        warning_label = customtkinter.CTkLabel(master=self.admin_app,
    ...
    def doctor_info(self):
        ...
        doctor_names_button = customtkinter.CTkButton(master=self.admin_app, text='Подтвердить',
    ...
    def procedures(self):
        procedures_1_label = customtkinter.CTkLabel(master=self.admin_app,
                                                    text='Процедуры консультации')
        procedures_1_label.grid(row=1, column=1, padx=20, pady=0)

        self.procedure_1_textbox = customtkinter.CTkTextbox(master=self.admin_app, corner_radius=0)
        self.procedure_1_textbox.grid(row=2, column=1, padx=20, pady=10)

        procedures_button = customtkinter.CTkButton(master=self.admin_app, text='Подтвердить',
                                                    command=self.procedure_1_callback)
        procedures_button.grid(row=3, column=1, padx=20, pady=10)

        procedures_2_label = customtkinter.CTkLabel(master=self.admin_app,
                                                    text='Процедуры диагностики')
        procedures_2_label.grid(row=1, column=2, padx=20, pady=0)

        self.procedure_2_textbox = customtkinter.CTkTextbox(master=self.admin_app, corner_radius=0)
        ...
        procedures_3_label = customtkinter.CTkLabel(master=self.admin_app,
                                                    text='Процедуры аппаратной косметологии лица')
        procedures_3_label.grid(row=1, column=3, padx=20, pady=0)

        self.procedure_3_textbox = customtkinter.CTkTextbox(master=self.admin_app, corner_radius=0)
        ...
        procedures_4_label = customtkinter.CTkLabel(master=self.admin_app,
                                                    text='Процедуры аппаратной косметологии тела')
        procedures_4_label.grid(row=1, column=4, padx=20, pady=0)

        self.procedure_4_textbox = customtkinter.CTkTextbox(master=self.admin_app, corner_radius=0)
        self.procedure_4_textbox.grid(row=2, column=4, padx=20, pady=10)

        procedures_button = customtkinter.CTkButton(master=self.admin_app, text='Подтвердить',
                                                    command=self.procedure_4_callback)
        procedures_button.grid(row=3, column=4, padx=20, pady=20)

        procedures_5_label = customtkinter.CTkLabel(master=self.admin_app,
                                                    text='Процедуры инъекционной косметологии для лица')
        procedures_5_label.grid(row=4, column=0, padx=20, pady=0)

        self.procedure_5_textbox = customtkinter.CTkTextbox(master=self.admin_app, corner_radius=0)
        self.procedure_5_textbox.grid(row=5, column=0, padx=20, pady=10)

        procedures_button = customtkinter.CTkButton(master=self.admin_app, text='Подтвердить',
                                                    command=self.procedure_5_callback)
        procedures_button.grid(row=6, column=0, padx=20, pady=20)

        procedures_6_label = customtkinter.CTkLabel(master=self.admin_app,
                                                    text='Процедуры инъекционной косметологии для тела')
        procedures_6_label.grid(row=4, column=1, padx=20, pady=0)

        self.procedure_6_textbox = customtkinter.CTkTextbox(master=self.admin_app, corner_radius=0)
        self.procedure_6_textbox.grid(row=5, column=1, padx=20, pady=10)

        procedures_button = customtkinter.CTkButton(master=self.admin_app, text='Подтвердить',
                                                    command=self.procedure_6_callback)
        procedures_button.grid(row=6, column=1, padx=20, pady=20)

        procedures_7_label = customtkinter.CTkLabel(master=self.admin_app,
                                                    text='Процедуры эстетической косметологии для лица')
        procedures_7_label.grid(row=4, column=2, padx=20, pady=0)

        self.procedure_7_textbox = customtkinter.CTkTextbox(master=self.admin_app, corner_radius=0)
        self.procedure_7_textbox.grid(row=5, column=2, padx=20, pady=10)

        procedures_button = customtkinter.CTkButton(master=self.admin_app, text='Подтвердить',
                                                    command=self.procedure_7_callback)
        procedures_button.grid(row=6, column=2, padx=20, pady=20)

        procedures_8_label = customtkinter.CTkLabel(master=self.admin_app,
                                                    text='Процедуры эстетической косметологии для тела')
        procedures_8_label.grid(row=4, column=3, padx=20, pady=0)

        self.procedure_8_textbox = customtkinter.CTkTextbox(master=self.admin_app, corner_radius=0)
        self.procedure_8_textbox.grid(row=5, column=3, padx=20, pady=10)

        procedures_button = customtkinter.CTkButton(master=self.admin_app, text='Подтвердить',
                                                    command=self.procedure_8_callback)
        procedures_button.grid(row=6, column=3, padx=20, pady=20)

        procedures_9_label = customtkinter.CTkLabel(master=self.admin_app,
                                                    text='Процедуры СПА ритуалов и услуг')
        procedures_9_label.grid(row=4, column=4, padx=20, pady=0)

        self.procedure_9_textbox = customtkinter.CTkTextbox(master=self.admin_app, corner_radius=0)
        self.procedure_9_textbox.grid(row=5, column=4, padx=20, pady=10)

        procedures_button = customtkinter.CTkButton(master=self.admin_app, text='Подтвердить',
                                                    command=self.procedure_9_callback)
        procedures_button.grid(row=6, column=4, padx=20, pady=20)
    ...
    def period(self):
        ...
        periods.grid(row=7, column=0, padx=20, pady=0)
        self.periods_textbox = customtkinter.CTkTextbox(master=self.admin_app, corner_radius=10)
        self.periods_textbox.grid(row=8, column=0, padx=20, pady=10)

        periods_button = customtkinter.CTkButton(master=self.admin_app, text='Подтвердить',
                                                 command=self.period_callback)
        periods_button.grid(row=9, column=0, padx=20, pady=10)
    ...
    def clear_all(self) -> None:
        ...
        clear_all_button.grid(row=9, column=4, padx=20, pady=0)


def admin():
    admin_app = AdminPanel()
    admin_app.admin_app.title('Admin panel')
    admin_app.admin_app.geometry('2000x2000')
