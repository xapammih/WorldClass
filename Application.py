...
class MainWindow:
    ...
    def wanted_result(self):
        self.wanted_result_entry = customtkinter.CTkEntry(master=self.app, width=350, placeholder_text="Желаемый результат: ")
    ...
    def step_1(self):
        ...
        step_1_combobox_1 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
                                                      command=self.step_1_combobox_callback_1)
        step_1_combobox_1.grid(row=2, column=0, padx=20, pady=0)

        step_1_combobox_2 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
                                                      command=self.step_1_combobox_callback_2)
        step_1_combobox_2.grid(row=2, column=1, padx=20, pady=0)

        step_1_combobox_3 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
                                                      command=self.step_1_combobox_callback_3)
        step_1_combobox_3.grid(row=2, column=2, padx=20, pady=0)

        step_1_combobox_4 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
                                                      command=self.step_1_combobox_callback_4)
        step_1_combobox_4.grid(row=2, column=3, padx=20, pady=0)

        step_1_combobox_5 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
    ...
    def step_2(self):
        ...
        step_2_combobox_1 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
                                                      command=self.step_1_combobox_callback_1)
        step_2_combobox_1.grid(row=2, column=5, padx=20, pady=0)

        step_2_combobox_2 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
                                                      command=self.step_1_combobox_callback_2)
        step_2_combobox_2.grid(row=2, column=6, padx=20, pady=0)

        step_2_combobox_3 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
                                                      command=self.step_1_combobox_callback_3)
        step_2_combobox_3.grid(row=2, column=7, padx=20, pady=0)

        step_2_combobox_4 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
                                                      command=self.step_1_combobox_callback_4)
        step_2_combobox_4.grid(row=2, column=8, padx=20, pady=0)

        step_2_combobox_5 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
                                                      command=self.step_1_combobox_callback_5)
    ...
    def step_3(self):
        ...
        step_3_combobox_1 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
                                                      command=self.step_3_combobox_callback_1)
        step_3_combobox_1.grid(row=10, column=0, padx=20, pady=0)

        step_3_combobox_2 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
                                                      command=self.step_3_combobox_callback_2)
        step_3_combobox_2.grid(row=10, column=1, padx=20, pady=0)

        step_3_combobox_3 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
                                                      command=self.step_3_combobox_callback_3)
        step_3_combobox_3.grid(row=10, column=2, padx=20, pady=0)

        step_3_combobox_4 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
                                                      command=self.step_3_combobox_callback_4)
        step_3_combobox_4.grid(row=10, column=3, padx=20, pady=0)

        step_3_combobox_5 = customtkinter.CTkComboBox(self.app, values=self.procedures_list,
