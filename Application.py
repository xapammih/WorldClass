...
class MainWindow:
    ...
    def step_1(self):
        ...
        step_1_commentary = customtkinter.CTkEntry(master=self.app, placeholder_text='Комментарий...')
        step_1_commentary.grid(row=7, column=0, padx=20, pady=0)
    ...
    def step_2(self):
        ...
        step_2_label.grid(row=1, column=5, padx=20, pady=20)

        step_2_combobox_1 = customtkinter.CTkComboBox(self.app, values=["option 1", "option 2"],
                                             command=self.step_1_combobox_callback_1)
        step_2_combobox_1.grid(row=2, column=5, padx=20, pady=20)

        step_2_combobox_2 = customtkinter.CTkComboBox(self.app, values=["option 1", "option 2"],
                                             command=self.step_1_combobox_callback_2)
        step_2_combobox_2.grid(row=2, column=6, padx=20, pady=20)

        step_2_combobox_3 = customtkinter.CTkComboBox(self.app, values=["option 1", "option 2"],
                                             command=self.step_1_combobox_callback_3)
        step_2_combobox_3.grid(row=2, column=7, padx=20, pady=20)

        step_2_combobox_4 = customtkinter.CTkComboBox(self.app, values=["option 1", "option 2"],
                                             command=self.step_1_combobox_callback_4)
        step_2_combobox_4.grid(row=2, column=8, padx=20, pady=20)

        step_2_combobox_5 = customtkinter.CTkComboBox(self.app, values=["option 1", "option 2"],
                                             command=self.step_1_combobox_callback_5)
        step_2_combobox_5.grid(row=2, column=9, padx=20, pady=20)

        step_2_label_procedures_count = customtkinter.CTkLabel(master=self.app, text='Кол-во процедур')
        step_2_label_procedures_count.grid(row=3, column=5, padx=20, pady=20)
        step_2_procedures_1 = customtkinter.CTkEntry(master=self.app)
        step_2_procedures_1.grid(row=4, column=5, padx=20, pady=20)

        step_2_procedures_2 = customtkinter.CTkEntry(master=self.app)
        step_2_procedures_2.grid(row=4, column=6, padx=20, pady=20)

        step_2_procedures_3 = customtkinter.CTkEntry(master=self.app)
        step_2_procedures_3.grid(row=4, column=7, padx=20, pady=20)

        step_2_procedures_4 = customtkinter.CTkEntry(master=self.app)
        step_2_procedures_4.grid(row=4, column=8, padx=20, pady=20)

        step_2_procedures_5 = customtkinter.CTkEntry(master=self.app)
        step_2_procedures_5.grid(row=4, column=9, padx=20, pady=20)

        step_2_label_period = customtkinter.CTkLabel(master=self.app, text='Период')
        step_2_label_period.grid(row=5, column=5, padx=20, pady=20)
        step_2_period = customtkinter.CTkEntry(master=self.app)
        step_2_period.grid(row=6, column=5, padx=20, pady=20)

        step_2_period = customtkinter.CTkEntry(master=self.app)
        step_2_period.grid(row=6, column=6, padx=20, pady=20)

        step_2_period = customtkinter.CTkEntry(master=self.app)
        step_2_period.grid(row=6, column=7, padx=20, pady=20)

        step_2_period = customtkinter.CTkEntry(master=self.app)
        step_2_period.grid(row=6, column=8, padx=20, pady=20)

        step_2_period = customtkinter.CTkEntry(master=self.app)
        step_2_period.grid(row=6, column=9, padx=20, pady=20)

    def step_3(self):
        step_3_label = customtkinter.CTkLabel(master=self.app, text='Шаг 3: Поддержка и...')
        step_3_label.grid(row=8, column=0, padx=30, pady=(10, 0))

        step_3_combobox_1 = customtkinter.CTkComboBox(self.app, values=["option 1", "option 2"],
                                             command=self.step_1_combobox_callback_1)
        step_3_combobox_1.grid(row=9, column=0, padx=20, pady=0)

        step_3_combobox_2 = customtkinter.CTkComboBox(self.app, values=["option 1", "option 2"],
                                             command=self.step_1_combobox_callback_2)
        step_3_combobox_2.grid(row=9, column=1, padx=20, pady=0)

        step_3_combobox_3 = customtkinter.CTkComboBox(self.app, values=["option 1", "option 2"],
                                             command=self.step_1_combobox_callback_3)
        step_3_combobox_3.grid(row=9, column=2, padx=20, pady=0)

        step_3_combobox_4 = customtkinter.CTkComboBox(self.app, values=["option 1", "option 2"],
                                             command=self.step_1_combobox_callback_4)
        step_3_combobox_4.grid(row=9, column=3, padx=20, pady=0)

        step_3_combobox_5 = customtkinter.CTkComboBox(self.app, values=["option 1", "option 2"],
                                             command=self.step_1_combobox_callback_5)
        step_3_combobox_5.grid(row=9, column=4, padx=20, pady=0)

        step_3_label_procedures_count = customtkinter.CTkLabel(master=self.app, text='Кол-во процедур')
        step_3_label_procedures_count.grid(row=10, column=0, padx=20, pady=0)
        step_3_procedures_1 = customtkinter.CTkEntry(master=self.app)
        step_3_procedures_1.grid(row=11, column=0, padx=20, pady=0)

        step_3_procedures_2 = customtkinter.CTkEntry(master=self.app)
        step_3_procedures_2.grid(row=11, column=1, padx=20, pady=0)

        step_3_procedures_3 = customtkinter.CTkEntry(master=self.app)
        step_3_procedures_3.grid(row=11, column=2, padx=20, pady=0)

        step_3_procedures_4 = customtkinter.CTkEntry(master=self.app)
        step_3_procedures_4.grid(row=11, column=3, padx=20, pady=0)

        step_3_procedures_5 = customtkinter.CTkEntry(master=self.app)
        step_3_procedures_5.grid(row=11, column=4, padx=20, pady=0)

        step_3_label_period = customtkinter.CTkLabel(master=self.app, text='Период')
        step_3_label_period.grid(row=12, column=0, padx=20, pady=0)
        step_3_period = customtkinter.CTkEntry(master=self.app)
        step_3_period.grid(row=13, column=0, padx=20, pady=0)

        step_3_period = customtkinter.CTkEntry(master=self.app)
        step_3_period.grid(row=13, column=1, padx=20, pady=0)

        step_3_period = customtkinter.CTkEntry(master=self.app)
        step_3_period.grid(row=13, column=2, padx=20, pady=0)

        step_3_period = customtkinter.CTkEntry(master=self.app)
        step_3_period.grid(row=13, column=3, padx=20, pady=0)

        step_3_period = customtkinter.CTkEntry(master=self.app)
        step_3_period.grid(row=13, column=4, padx=20, pady=0)

        step_3_commentary = customtkinter.CTkEntry(master=self.app, placeholder_text='Комментарий...')
        step_3_commentary.grid(row=14, column=0, padx=20, pady=10)
